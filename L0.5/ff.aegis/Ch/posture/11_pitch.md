...
**L0.5 · Posture · Aegis** — 使用正速度和带符号目标位置调整机身俯仰；负位置向下、正位置向上。
...
| `position_rad` | `float [-0.368, 0.4]` | — | 可用 | 带符号目标姿态位置，单位为弧度。 |
| `position_deg` | `float [-21.11, 22.98]` | — | 可用 | 带符号目标姿态位置，单位为度。 |
<!-- END: Parameters -->

<!-- START: Behavior -->
## 行为

使用正速度和带符号目标位置调整机身俯仰；负位置向下、正位置向上。
<!-- END: Behavior -->
