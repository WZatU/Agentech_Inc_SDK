...
**L0.5 · Posture · Aegis** — 使用正速度和带符号目标位置调整机身横滚；负位置向左、正位置向右。
...
| `position_rad` | `float [-0.463, 0.461]` | — | 可用 | 带符号目标姿态位置，单位为弧度。 |
| `position_deg` | `float [-26.6, 26.4]` | — | 可用 | 带符号目标姿态位置，单位为度。 |
<!-- END: Parameters -->

<!-- START: Behavior -->
## 行为

使用正速度和带符号目标位置调整机身横滚；负位置向左、正位置向右。
<!-- END: Behavior -->
