...
**L0.5 · Safety · Aegis** — Stop the current motion while the dog remains standing.
...
1. This Skill accepts no parameters.
<!-- END: Constraints -->
...
Stop the current motion while the dog remains standing.
<!-- END: Behavior -->
