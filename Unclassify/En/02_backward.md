...
Agentech.backward(pace: str, duration_s: float)                # development
...
6. `pace`, `step_count`, and `step_rate_hz` are still under development and physical validation.
<!-- END: Constraints -->
...
| `pace` | enum `{slow, normal, fast}` | Named pace profile; development |
